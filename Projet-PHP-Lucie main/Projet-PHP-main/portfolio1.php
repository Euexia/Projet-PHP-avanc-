        ...
        <header id="header">
            <nav class="navbar navbar-expand-lg shadow-lg mb-4 bg-light fixed-top">
              <div class="container-fluid">
                <a class="nav-link text-danger fw-bold fs-4" style="margin-right: 10px; margin-left: 10px" href="index.html">Accueil</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav">
                    ...
                    <a class="nav-link text-dark fs-5" style="margin-right: 10px; margin-left: 10px" href="index.php">Contact</a>
          ...
          <h1>Presentations du projet</h1>

          <h2>A completer avec les futurs projets</h2>
